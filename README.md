...
[![Release](http://img.shields.io/badge/release-1.2.0-47b31f.svg)](https://github.com/akhikhl/gretty/releases/latest)
[![Snapshot](http://img.shields.io/badge/current-1.2.1--SNAPSHOT-47b31f.svg)](https://github.com/akhikhl/gretty/tree/master)
...
Mar 6, 2015: Gretty 1.2.0 is out and immediately available at [Gradle plugin portal](http://plugins.gradle.org/plugin/org.akhikhl.gretty), 
...
See [Gretty 1.2.0 release announcement](RELEASE.md#gretty-120-release-announcement) for more information.
