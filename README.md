...
[![Release](http://img.shields.io/badge/release-1.1.6-47b31f.svg)](https://github.com/akhikhl/gretty/releases/latest)
[![Snapshot](http://img.shields.io/badge/current-1.1.7--SNAPSHOT-47b31f.svg)](https://github.com/akhikhl/gretty/tree/master)
...
- Gretty 1.1.6 is out and immediately available at [Gradle plugin portal](http://plugins.gradle.org/plugin/org.akhikhl.gretty), [Bintray](https://bintray.com/akhikhl/maven/gretty/view) and [Maven Central](http://search.maven.org/#search|ga|1|g%3A%22org.akhikhl.gretty%22).
