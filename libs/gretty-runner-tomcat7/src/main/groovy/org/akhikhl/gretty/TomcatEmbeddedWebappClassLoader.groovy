 ...
 * Changes compared to original version: converted to groovy, replaced logging to slf4j
 *
 * @author akhikhl
 */
class TomcatEmbeddedWebappClassLoader extends WebappClassLoader {

	private static final Logger log = LoggerFactory.getLogger(TomcatEmbeddedWebappClassLoader)
